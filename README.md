...
- keeping zero-credential onboarding strict through guided setup and wizard preflight checks, config explanation, connector diagnostics, browser doctor/artifact inspection, task packs, static dashboards, advice-only HTML run repair packages, and business templates for coding, research, data, ops, browser automation, support, sales, documents, QA, and release checks
